...
LIST ;
 ...
 . I TYPE>9 D
 . . S CHILD=""
 . . F  S CHILD=$O(@NODE@(CHILD)) Q:CHILD=""  S CCNT=CCNT+1
 . S NAME=SUB
 . I TYPE>9 S NAME=SUB_" ("_CCNT_")"
 . D ADDITEM^WVECWS(COUNT,NAME,VALUE,TYPE,NODE)
...
FIND ; Find Immediate Child
 ...
 S MATCH=0
 S SUB=""
 F  S SUB=$O(@REF@(SUB)) Q:SUB=""  D  Q:MATCH
 . S COUNT=COUNT+1
 . I $$UP^XLFSTR(SUB)[TEXT S MATCH=COUNT
